 ...
 * @UniqueEntity(fields={"title"}, message="Un programme avec le même titre existe déjà")
 */
class Program
{
    /**
     ...
     * @Assert\Length(max="255", maxMessage="Le titre est trop long, ne dépassez pas {{limit}} caractères")
     */
    private $title;
